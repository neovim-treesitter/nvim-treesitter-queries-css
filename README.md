...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-css/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-css/actions/workflows/validate.yml)

Neovim tree-sitter queries for **css**, part of the
...
- [ ] Changes are scoped to `css` — do not include files for other languages
